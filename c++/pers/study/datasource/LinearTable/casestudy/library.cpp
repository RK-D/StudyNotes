...
public:
    ...
    int strcmp(char *name, char *name1) const;
...
public:
    CheckedOutBook(list<Author>::iterator ar = list<Author>::iterator(0) ,
                   list<Book>::iterator bk = list<Book>::iterator(0)) {
        author = ar;
        book = bk;
    }
...
int Author::strcmp(char *name, char *name1) const {
    return 0;
}
